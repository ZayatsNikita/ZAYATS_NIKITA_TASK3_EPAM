...
{
    /// <summary>
    /// Сlass that describes a Paper Rectangle.
    /// </summary>
    public class PaperRectangle : Rectangle, IPaper
    {
        /// <summary>
        /// A constructor that cuts paper rectangle from another paper shape.
        /// </summary>
        ...
        /// <summary>
        /// Constructor that creates a paper rectengle with a given sides.
        /// </summary>
        ...
        /// <summary>
        /// The method that is responsible for painting the paper rectangle.
        /// </summary>
