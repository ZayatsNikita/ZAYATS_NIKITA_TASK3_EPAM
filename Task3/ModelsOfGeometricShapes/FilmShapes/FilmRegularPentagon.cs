...
{
    /// <summary>
    /// Сlass that describes a Film Regular Pentagon.
    /// </summary>
    public class FilmRegularPentagon : RegularPentagon,IFilm
    {
        /// <summary>
        /// A constructor that cuts film regular pentagon from another film shape.
        /// </summary>
        ...
        /// <summary>
        /// Constructor that creates a film regular pentagon with a given sides.
        /// </summary>
        ...
        /// <summary>
        /// The method that is responsible for painting the film regular pentagon.
        /// </summary>
